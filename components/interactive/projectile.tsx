...
export default function Projectile() {
    ...
    const callback = async (bodyA: Body, bodyB: Body) => {
        if(bodyA.label === "Projectile" && bodyB.label === "Destination") {
            ...
            if (trigger) {
                setClicked(true);
                await savePoints(50, 0, "Projectile");
                trigger.click();
            }
        }
        else{
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-gray-700">
                        The <span className="font-semibold text-red-500">red ball</span> is at x = 30 and the <span className="font-semibold text-green-600">green ball</span> is at x = 450. 
